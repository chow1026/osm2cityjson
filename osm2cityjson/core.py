...
# @click.option('--hide_errors', is_flag=True,
#               help='Do not print all the errors.')
# @click.option('--skip_schema', is_flag=True,
#               help='Skip the schema validation (since it can be painfully slow).')
...
#                     "Folder for schemas unknown. Validation aborted.",
#                     fg='red'))
#                 return cm
#             else:
#                 print_cmd_status(
...
#             skip_schema=skip_schema, folder_schemas=folder_schemas)
#         click.echo('=====')
#         if bValid == True:
...
#               help='The ID of the City Objects; can be used multiple times.')
# @click.option('--bbox', nargs=4, type=float,
#               help='2D bbox: (minx miny maxx maxy).')
# @click.option('--random', type=int,
#               help='Number of random City Objects to select.')
# @click.option('--cotype',
#               type=click.Choice(
#                   ['Building', 'Bridge', 'Road', 'TransportSquare', 'LandUse',
#                    'Railway', 'TINRelief', 'WaterBody', 'PlantCover',
#                    'SolitaryVegetationObject', 'CityFurniture',
#                    'GenericCityObject', 'Tunnel']),
#               help='The City Object type')
# @click.option('--exclude', is_flag=True,
#               help='Excludes the selection, thus delete the selected object(s).')
...
# @click.option('--digit', default=3, type=click.IntRange(1, 10),
...
#               help='Convert texture file paths to relative paths.')
...
#         print_cmd_status('Translating the file by: (%f, %f, %f)' % (
